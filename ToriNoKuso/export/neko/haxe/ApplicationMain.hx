...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("ToriNoKuso", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("ToriNoKuso", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "ToriNoKuso";
		app.meta["name"] = "ToriNoKuso";
